                                            ...
                                            <table id="datatable" class="table table-bordered">
												...
												<?php foreach ($blog as $row){?>
                                                    <tr>
                                                        ...
                                                        <td><img src=<?php echo base_url()."uploads/images/blog/$row->banner"; ?> height="150" width="200"> </td>
    													<td><a href="update_blog/<?php echo $row->id; ?>"><li class="fa fa-edit p-2 text-info" style="font-size: 30px"></li></a>
                                                            <a href="deleteblog/<?php echo $row->id; ?>"><li class="fa fa-trash p-2 text-danger" style="font-size: 30px"></li></a>
