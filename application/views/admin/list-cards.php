                                            ...
                                            <table id="datatable" class="table table-bordered">
                                                ...
                                                <?php foreach ($cards as $row){?>
                                                    <tr>
                                                        ...
                                                        <td><img src="<?php echo base_url()."uploads/images/card/$row->image"; ?>" height="150" width="200"> </td>
                                                        <td><a href="update_card/<?php echo $row->id; ?>"><li class="fa fa-edit p-2 text-info" style="font-size: 30px"></li></a>
                                                            <a href="deletecard/<?php echo $row->id; ?>"><li class="fa fa-trash p-2 text-danger" style="font-size: 30px"></li></a>
