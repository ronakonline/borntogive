                                            ...
                                            <table id="datatable" class="table table-bordered">
												...
												<?php foreach ($testimonial as $row){?>
                                                    <tr>
                                                        ...
                                                        <td><img src="<?php echo base_url()."uploads/images/testimonial/$row->profile"; ?>" height="150" width="200"> </td>
    													<td><a href="update_testimonial/<?php echo $row->id; ?>"><li class="fa fa-edit p-2 text-info" style="font-size: 30px"></li></a>
                                                            <a href="deletetestimonial/<?php echo $row->id; ?>"><li class="fa fa-trash p-2 text-danger" style="font-size: 30px"></li></a>
