					...
					<div class="row">
						<div class="col-12">
							<div class="card m-b-30">
								<div class="card-body">
									<form method="post" action="<?php echo base_url('admin/Testimonial/')?>add_testimonial" enctype="multipart/form-data">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<textarea rows="5" class="form-control" name="feedback" required></textarea>
											</div>
										</div>
											...
											<div class="col-md-10 ">
												<div class="input-group mt-2">
													<div class="custom-file">
														<input type="file" class="custom-file-input" name="profile"  id="src2" required>
